...
function checkzixun(theform){
  var title = theform.elements["title"].value;
	...
	var tips="";
	if(Utils.isEmpty(title)) tips+=title_null+"\n";
	if(Utils.isEmpty(content)) tips+=content_null+"\n";
	if(tips){
		alert(tips);
		return false;
	}
...
function checkcomment(theform){
  var rank = theform.elements["comment_rank"].value;
	...
	var tips="";
	if(Utils.isEmpty(rank)) tips+=score_null+"\n";
	if(Utils.isEmpty(content)) tips+=content_null+"\n";
	if(captcha.value==captcha.defaultValue||Utils.isEmpty(captcha.value)) tips+=null_captcha_login+"\n";
	if(tips){
		alert(tips);
		return false;
	}
