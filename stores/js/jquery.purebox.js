		...
		_init : function(options) {
			var opts = $.extend({}, purebox.defaults, options || {}),
				template = ['<div id="',opts.id,'" class="pb"><div class="cboxContent">',
				           ...
				           '<div class="pb-bd"><div class="pb-ct"></div></div>' + ( opts.timeCozuo ? '<div class="dialog_buttons_bar"><time class="countdown"><span id="time" class="org">' +opts.time+ '</span> 秒后关闭窗口</time></div>':''),
