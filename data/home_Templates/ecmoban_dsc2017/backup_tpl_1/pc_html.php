...
<div class="content" style="min-height: 922px;"><div class="visual-item" data-mode="lunbo" data-purebox="banner" data-li="1" data-length="5" ectype="visualItme" style="display: block;" data-diff="0">
	    ...
	    <li style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984992503176615.jpg) center center no-repeat;"><div class="banner-width"><a href="" style="height:500px;"></a></div></li>
    	    <li style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984990506843460.jpg) center center no-repeat;"><div class="banner-width"><a href="" style="height:500px;"></a></div></li>
    	    <li style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984991783527346.jpg) center center no-repeat;"><div class="banner-width"><a href="" style="height:500px;"></a></div></li>
...
<div class="channel-column" style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984987302153402.jpg) no-repeat;">
    <div class="column-title">
            <h3>优质新品</h3>
        <p>专注生活美学</p>
    </div>
    <div class="column-img"><img src="http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494985002375136884.png"></div>
    <a href="" target="_blank" class="column-btn">去看看</a>
</div>
<div class="channel-column" style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984989930757668.jpg) no-repeat;">
    <div class="column-title">
            <h3>潮流女装</h3>
        <p>春装流行款抢购</p>
    </div>
    <div class="column-img"><img src="http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984989766362152.png"></div>
    <a href="" target="_blank" class="column-btn">去看看</a>
</div>
<div class="channel-column" style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984989391013089.jpg) no-repeat;">
    <div class="column-title">
            <h3>人气美鞋</h3>
        <p>新外貌“鞋”会</p>
    </div>
    <div class="column-img"><img src="http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984990383161028.png"></div>
    <a href="" target="_blank" class="column-btn">去看看</a>
</div>
<div class="channel-column" style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984987606903394.jpg) no-repeat;">
    <div class="column-title">
            <h3>品牌精选</h3>
        <p>潮牌尖货 初春换新</p>
    </div>
    <div class="column-img"><img src="http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984988032635434.png"></div>
    <a href="" target="_blank" class="column-btn">去看看</a>
</div>
<div class="channel-column" style="background:url(http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984990175755536.jpg) no-repeat;">
    <div class="column-title">
            <h3>护肤彩妆</h3>
        <p>春妆必买清单 低至3折</p>
    </div>
    <div class="column-img"><img src="http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984991251825734.png"></div>
    <a href="" target="_blank" class="column-btn">去看看</a>
</div>
...
<div class="home-brand-adv slide_lr_info">
        <a href="" target="_blank"><img src="http://localhost/ecmoban_dsc2.2.6_20170727/data/gallery_album/2/original_img/1494984992104112514.jpg" class="slide_lr_img"></a>
    </div>
