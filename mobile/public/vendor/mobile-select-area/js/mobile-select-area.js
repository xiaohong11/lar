...
//					height: 215
		...
		f: function(data) {
			...
			if (_this.index !== 0 && _this.value[_this.index - 1] == "0" && this.default == 0) {
				...
				if (item.length > 0 && this.default == 1) {
                    ...
                    if (_this.value[this.index] == undefined) {
						_this.value[this.index] = item[item.length-1].id || 0;
						_this.text[this.index] = item[item.length-1].name;
                    }
		...
		submit: function() {
			if(this.settings.callback && this.settings.callback.call(this, this.scroller, this.text, this.value)){
                this.oldvalue = this.value.concat([]);
                this.oldtext = this.text.concat([]);
