...
class Index extends \app\http\base\controllers\Frontend
{
	...
	public function actionIndex()
	{
		...
		if ((0 < $goods['dis_commission']) && ($goods['is_distribution'] == 1) && !empty($this->user_id) && (isset($_GET['drp']) === false)) {
			$this->redirect('goods/index/index', array('id' => $this->goods_id, 'drp' => $this->user_id));
		}
